...
function buildGuestLink() {
    ...
    const slug = getGuestSlug(guestName);
    if (slug) params.set('to', slug);
...
window.addEventListener('load', () => {
    ...
    const notifMsgEl = document.getElementById('notifMessage');
    if (notifMsgEl) notifMsgEl.textContent =
        `Hi ${guestName}, 🎓 you have 1 new invitation from Hung! Tap to open ✨`;
